...
// Validate ../../app/api/interview/stream/route.ts
{
  type __IsExpected<Specific extends RouteHandlerConfig<"/api/interview/stream">> = Specific
  const handler = {} as typeof import("../../app/api/interview/stream/route.js")
  type __Check = __IsExpected<typeof handler>
  // @ts-ignore
  type __Unused = __Check
}
